...
export interface EndpointSet {
  ...
  /**
   * Tool-call Pipeline 审核：JPrx 转发（cmd 4076），请求体为 PipelineEnvelope。
   */
...
const ENV_ENDPOINTS: Record<EndpointEnv, EndpointSet> = {
  test: {
    ...
    pipelineAudit: "https://jprx.sparta.html5.qq.com/api/v1/4217",
  },
  production: {
    ...
    pipelineAudit: "https://jsonproxy.3g.qq.com/api/v1/4217",
  },
};
...
/** Tool-call Pipeline 审核 URL（LLMShieldClient.auditPipeline） */
export function getPipelineAuditUrl(): string {
  return ENV_ENDPOINTS[currentEnv].pipelineAudit;
}
